                                        ...
                                        foreach ($req as $r) { ?>
                                          <tr>
                                              ...
                                              <?php if ($r->status == 'Tunggu'){
                                                ?><td><span class="badge badge-warning">Tunggu</span></td><?php
                                              } else {
                                                ?><td><span class="badge badge-success">Terkirim</span></td><?php
                                              } ?>
                                              <td><?= $r->tanggal ?></td>
                                              <?php if ($r->status == 'Tunggu'){
                                                ?><td><button class="btn btn-warning btn-sm mb-2" data-toggle="modal" data-target="#input<?= $r->id_req ?>">Kirim Bahan</button></td><?php
                                              } else {
                                                ?><td><span class="badge badge-success">Sudah Dikirim</span></td><?php
                                              } ?>
                                              </td>
                                              <!-- Modal Tambah -->
