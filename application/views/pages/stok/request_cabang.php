                                      ...
                                      <?php $n = 1;
                                        foreach ($req as $r) { ?>
                                          <tr>
                                              ...
                                              <td><?php if ($r->status == 'Tunggu'){
                                                ?><span class="badge badge-warning">Tunggu</span></td><?php
                                              } else {
                                                ?><span class="badge badge-success">Dikirim</span></td><?php
                                              } ?>
                                              <td><?= $r->tanggal ?></td>
                                              <td><?php if ($r->status == 'Tunggu'){
                                                ?><button class="btn btn-danger btn-sm mb-2" data-toggle="modal" data-target="#hapus<?= $r->id_req ?>"><i class="fas fa-trash-alt"></i> Batal</button><?php
                                            } else {
                                              ?><span class="badge badge-success">Selesai</span></td><?php
                                            } ?>
