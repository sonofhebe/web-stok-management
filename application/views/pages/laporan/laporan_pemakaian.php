      ...
      <div class="main-content">
      	<section class="section">
      		<div class="section-header">
      			<h1>Laporan Pemakaiann</h1>
      			<div class="section-header-breadcrumb">
      				<div class="breadcrumb-item active"><a href="<?= base_url('dashboard') ?>">Dashboard</a></div>
      				<div class="breadcrumb-item">Laporan Pemakaian</div>
      			</div>
      		</div>
      	...
      	<div class="card">
      		<div class="card-body">
      			<div class="row">
      				<div class="col-lg-12">
      					<h5 class="ml-2 mt-2 mb2"><b>Laporan Pemakaian Bahan</b></h5>
      					<div class="row">
      						<div class="col-md-6">
      							<div class="card">
      								<div class="card-body">
      									<h6>Mingguan</h6>
      									<form action="<?= base_url('pemakaian-mingguan') ?>" method="post" enctype="multipart/form-data">
      										<div class="row">
      											<div class="col-12">
      												<div class="form-group">
      													<div class="row">
      														...
      														<div class="col-md-6">
      															<label>Minggu</label>
      															<input name="awal" id="awl" class="form-control" required type="dategate2" placeholder="pilih tanggal awal">
      														</div>
      													</div>
      												</div>
      												<div class="form-group">
      						...
      						<div class="col-md-6">
      							<div class="card">
      								<div class="card-body">
      									<h6>Bulanan</h6>
      									<form action="<?= base_url('pemakaian-bulanan') ?>" method="post" enctype="multipart/form-data">
      										<div class="row">
      											<div class="col-12">
      												<div class="form-group">
      													<div class="row">
      					...
      					<h5 class="ml-2 mt-2 mb2"><b>Laporan dengan SC</b></h5>
      					<div class="row">
      						<div class="col-md-6">
      							<div class="card">
      								<div class="card-body">
      									<h6>Mingguan</h6>
      									<form action="<?= base_url('sc-mingguan') ?>" method="post" enctype="multipart/form-data">
      										<div class="row">
      											<div class="col-12">
      												<div class="form-group">
      													<div class="row">
      						...
      						<div class="col-md-6">
      							<div class="card">
      								<div class="card-body">
      									<h6>Bulanan</h6>
      									<form action="<?= base_url('sc-bulanan') ?>" method="post" enctype="multipart/form-data">
      										<div class="row">
      											<div class="col-12">
      												<div class="form-group">
      													<div class="row">
