      ...
      <div class="main-content">
          ...
          <div class="card">
              <div class="card-body">
                  <div class="row">
                      <div class="col-lg-12">
                          <h5 class="ml-2 mt-2 mb2"><b>Laporan Penjualan Produk</b></h5>
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="card">
                                      <div class="card-body">
                                          <h6>Mingguan</h6>
                                          <form action="<?= base_url('penjualan-mingguan') ?>" method="post" enctype="multipart/form-data">
                                              <div class="row">
                                                  <div class="col-12">
                              ...
                              <div class="col-md-6">
                                  <div class="card">
                                      <div class="card-body">
                                          <h6>Bulanan</h6>
                                          <form action="<?= base_url('penjualan-bulanan') ?>" method="post" enctype="multipart/form-data">
                                              <div class="row">
                                                  <div class="col-12">
                                                      <div class="form-group">
                                                          <div class="row">
