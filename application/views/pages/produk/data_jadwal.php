    ...
    <div class="row">
              <div class="col-lg-12">
                  ...
                  <?php if ($this->session->userdata('role_id') == 1) { ?>
                                        ...
                                        <!-- Modal Hapus -->
                                        <div class="modal fade" id="hapus<?= $data->id_jadwal ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?= base_url('hapus-jadwal/') . $data->id_jadwal ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Hapus Data</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal fade" id="tambahjadwal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('tambah-jadwal')?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="">Produk</label>
                                    <select name="id_produk" id="" class="form-control" required>
