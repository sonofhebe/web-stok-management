                                      ...
                                      <?php $n = 1;
                                        foreach ($produk as $data) { ?>
                                          <tr>
                                              ...
                                              <td>
                                                  <div class="btn-group">
                                                  <form action="<?= base_url('inputsession-resep') ?>" method="post">
                                                        <input type="hidden" id="idp" name="idp" value="<?= $data->id_produk ?>">
                                                        <input type="submit" class="btn btn-warning btn-sm" value="Lihat Resep">
                                                    </form>
                                                </div>
                                              </td>
                  <?php if ($this->session->userdata('role_id') == 1) { ?>
