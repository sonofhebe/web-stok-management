...
class penjualan extends CI_Controller
{
	...
	public function index()
	{
		...
		$data = array(
			...
			'produk'    => $this->penjualan_model->getProdukVariant(),
			'tgl'            => $tgll,
	...
	public function tambahpenjualan()
	{
		...
		if ($cek) {
			...
			//cek stok dapur
			$cekStok = $this->penjualan_model->cekStok($id_dapur, $produk, $jumlah);
			if (count($cekStok) == 0) {
				...
				$id_penjualan = $this->penjualan_model->inputpenjualan($data);
				$this->penjualan_model->usePackaging($data, $id_penjualan);
