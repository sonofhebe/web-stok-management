...
class laporan_pemakaian extends CI_Controller
{
    public function __construct()
    {
        ...
        cek_login();
        role1();
        $this->load->model('laporanpemakaian_model');
    }
    ...
    public function index()
    {
        $data = array(
            'title' => 'Cetak Laporan',
            'katbahan'        => $this->laporanpemakaian_model->katbahan(),
            'dapur'        => $this->laporanpemakaian_model->dapur()
        );

        $this->load->view('template/header.php', $data);
        $this->load->view('template/sidebar.php', $data);
        $this->load->view('pages/laporan/laporan_pemakaian.php', $data);
